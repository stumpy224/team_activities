...
Member.create(identifier: 'OPR2312', name: 'Kimberly Fawbush', active: true)
...
Member.create(identifier: 'OPRTEK2', name: 'Sunil Kashetty', active: true)
Member.create(identifier: 'OPR2113', name: 'Shannon Lebryk', active: true)
...
Member.create(identifier: 'OPR5104', name: 'Alex Scriven', active: true)
